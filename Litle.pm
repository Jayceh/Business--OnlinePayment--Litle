...
sub map_request {
    ...
    $content->{'invoice_number_length_15'} = $content->{'invoice_number'} if ! defined $content->{'invoice_number_length_15'};
    ...
    my @validate = (
      ...
      [ 'shipping',     8,      0,             1, 0 ],
      [ 'duty',         8,      0,             1, 0 ],
      ['invoice_number',25,     0,             0, 0 ], # orderID = 25
      ['invoice_number_length_15',15,0,        0, 0 ], # invoiceReferenceNumber = 15
